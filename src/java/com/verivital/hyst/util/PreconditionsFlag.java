...
public enum PreconditionsFlag
{
	...
	// conversion checks
	CONVERT_NONDETERMINISTIC_RESETS, CONVERT_INTERVAL_CONST_TO_VAR, CONVERT_TO_FLAT_AUTOMATON, CONVERT_DISJUNCTIVE_GUARDS, CONVERT_ALL_FLOWS_ASSIGNED, CONVERT_CONSTANTS_TO_VALUES, SIMPLIFY_EXPRESSIONS, CONVERT_AFFINE_TERMS, COLLAPSE_IDENTICAL_JUMPS,
